...
```{r,echo=T, fig.height=8,fig.width=7, cache=TRUE}
...
# This function calculates log2 fold chnage values between the defined groups
...
```{r,echo=T, fig.align="center", fig.height=6, fig.width=6, cache=TRUE}
...
#### B vs A 
```{r,echo=T, fig.align="center", fig.height=6, fig.width=8, cache=TRUE}
...
#### B vs A   
```{r, echo=T, fig.align="center", fig.height=8,fig.width=6, cache=TRUE}
...
#### B vs A   
```{r , echo=T,fig.align="center", fig.height=8, fig.width=8, cache=TRUE}
...
```{r , echo=T, warning=F, message=FALSE, fig.align="center", fig.height=6, fig.width=6, cache=TRUE}

# set seed that can be used later to reproduce results
set.seed(123)
...
#### B vs A 
```{r, echo=T, warning=F, fig.align="center", fig.height=8,fig.width=6, cache=TRUE}

# Generates the Z scores waterfall plots
...
#### B vs A 
```{r, echo=T, warning=F, fig.align="center", fig.height=6, fig.width=6, cache=TRUE}
...
#### B vs A   
```{r , echo=T, fig.align="center", fig.height=8,fig.width=8, message=FALSE, cache=TRUE}
