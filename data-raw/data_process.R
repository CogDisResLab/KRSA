...
KRSA_Mapping_STK_PamChip_87102_v1 <- read_csv("data-raw/KRSA_Mapping_STK_PamChip_87102_v1.csv")

KRSA_Mapping_PTK_PamChip_86402_v1 <- read_csv("data-raw/KRSA_Mapping_PTK_PamChip_86402_v1.csv")
